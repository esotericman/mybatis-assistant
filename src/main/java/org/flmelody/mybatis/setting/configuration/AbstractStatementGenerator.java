...
import org.flmelody.mybatis.service.EditorService;
import org.flmelody.mybatis.service.JavaService;
import org.flmelody.mybatis.ui.ListSelectionListener;
import org.flmelody.mybatis.ui.UiComponentFacade;
...
import static org.flmelody.mybatis.setting.configuration.GeneratorHolder.ALL;
...
public abstract class AbstractStatementGenerator {
    ...
    public void execute(@NotNull final PsiMethod method, final Project project) {
        ...
        if (1 == mappers.size()) {
            ...
            Collection<String> paths = Collections2.transform(mappers, FUN::apply);
