...
import org.flmelody.mybatis.util.ClassCreator;
...
public class MybatisClassPathDynamicClassLoader extends ClassLoader {
    private final PsiClass psiClass;

    public MybatisClassPathDynamicClassLoader(PsiClass psiClass) {
